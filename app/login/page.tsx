      ...
      <div className="relative flex min-h-screen items-center justify-center px-4 pt-16">
        <Card className="w-full max-w-md animate-fade-in border-border/50 bg-card/80 backdrop-blur-xl">
          <CardHeader className="text-center">
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-primary glow-blue">
              <Gamepad2 className="h-8 w-8 text-primary-foreground" />
            </div>
            <CardTitle className="text-2xl">Welcome Back</CardTitle>
            <CardDescription>Login untuk mengakses dashboard dan memesan server game Anda</CardDescription>
          </CardHeader>
